...
<div class="main-header">
    ...
    <p>Tác giả: Đoàn Thanh Hương - Trường Tiểu học Hùng An - ĐT: 0827 241 077</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đoàn Thanh Hương - Trường Tiểu học Hùng An - ĐT: 0827 241 077</div>", unsafe_allow_html=True)
